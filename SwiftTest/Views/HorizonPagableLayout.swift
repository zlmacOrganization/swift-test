...
//  SwiftTest
//
//  Created by zhangliang on 2023/9/11.
//  Copyright © 2023 zhangliang. All rights reserved.
//

import UIKit

class HorizonPagableLayout: UICollectionViewFlowLayout {
    fileprivate var attributesArr: [UICollectionViewLayoutAttributes] = []
        ...
        override func prepare() {
            ...
            let itemWH: CGFloat = kMainScreenWidth / CGFloat(col)
            ...
            for itemIndex in 0..<itemsCount {
                ...
                // 通过一系列计算, 得到x, y值
                let x = itemSize.width * CGFloat(itemIndex % Int(col)) + (CGFloat(page) * kMainScreenWidth)
